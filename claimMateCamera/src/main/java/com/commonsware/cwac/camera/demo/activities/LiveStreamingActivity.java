...
import com.commonsware.cwac.camera.demo.other.PermissionChecker;
...
public class LiveStreamingActivity extends AppCompatActivity implements WebRtcClient.RtcListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countDownTimer = new CountDownTimer(60 * 60 * 60, 1000) {
            @Override
        ...
        mSocketAddress = "http://192.168.0.103:3000/";
    ...
    private void checkPermissions() {
        permissionChecker.verifyPermissions(this, RequiredPermissions, new PermissionChecker.VerifyPermissionsCallback() {
            ...
            public void onPermissionDeny(String[] permissions) {
                Toast.makeText(LiveStreamingActivity.this, "Please grant required permissions.", Toast.LENGTH_LONG).show();
            }
        });
    }
...
//        startActivityForResult(Intent.createChooser(msg, "Call someone :"), VIDEO_CALL_SENT);
    ...
    public void startCam() {
        ...
        if (PermissionChecker.hasPermissions(this, RequiredPermissions)) {
            client.start(PrefManager.getFullName());
            zoomIn = AnimationUtils.loadAnimation(this, R.anim.lodder_zoom_out_anim);
            imgLive.setAnimation(zoomIn);
            zoomIn.start();
