 ...
 * 
 *         Example. FirstTimePreference prefFirstTime = new
 *         FirstTimePreference(getApplicationContext()); if
 *         (prefFirstTime.runTheFirstNTimes("myKey" , 3)) {
 *         Toast.makeText(this,"Test myKey & coutdown: "+
